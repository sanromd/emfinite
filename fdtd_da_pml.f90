subroutine em_da_pml_q3(aux,pml,s3,s4,q1,q2,q3,na,np,xi,xf,yi,yf,gxi,gxf,gyi,gyf)
...
end subroutine em_da_pml_q3

subroutine em_da_pml_q12(aux,pml,s1,s2,q1,q2,q3,na,np,xi,xf,yi,yf,gxi,gxf,gyi,gyf)
...
end subroutine em_da_pml_q12

subroutine em_da_q3(aux,dxdt,dydt,s3,s4,q1,q2,q3,na,xi,xf,yi,yf,gxi,gxf,gyi,gyf)
  ! f2py intent(inplace) s3, s4
  implicit none
...
subroutine em_da_q12(aux,dxdt,dydt,s1,s2,q1,q2,q3,na,xi,xf,yi,yf,gxi,gxf,gyi,gyf)
...
subroutine fdtd_pml(aux,pml,dxdt,dydt,s3,s4,q1,q2,q3,na,np,xi,xf,yi,yf,gxi,gxf,gyi,gyf,q_type,pml_decomp)
